...
@section('title', 'Create Course-Student Assignment')

@section('content')
    <div style="margin-bottom: 40px;">
        <h1 style="color: #ABC28B; font-size: 2.5rem; font-weight: 700; margin: 0;">New Assignment</h1>
        <p style="color: #677C56; font-size: 1rem; margin-top: 0.5rem;">Enroll a student in a course</p>
    </div>
    ...
    <div style="max-width: 600px; background: #fff; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 6px rgba(171, 194, 139, 0.15);">
        <form action="{{ route('course_students.store') }}" method="POST">
            ...
            <div style="margin-bottom: 1.5rem;">
                <label for="course_id" style="display: block; color: #ABC28B; font-weight: 600; margin-bottom: 0.5rem;">Course <span style="color: #112C01;">*</span></label>
                <select name="course_id" id="course_id" style="width: 100%; padding: 0.75rem; border: 2px solid #e0e7d8; border-radius: 6px; font-size: 1rem; background-color: #f9fafb; color: #333; transition: border-color 0.2s ease;" onchange="this.style.borderColor='#ABC28B';" onfocus="this.style.borderColor='#ABC28B';" onblur="this.style.borderColor='#e0e7d8';" required>
                ...
                @error('course_id')
                    <p style="color: #112C01; font-size: 0.875rem; margin-top: 0.25rem;">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div style="display: flex; gap: 1rem;">
                <button type="submit" style="padding: 0.75rem 1.5rem; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #fff; border: none; border-radius: 8px; font-size: 1rem; font-weight: 600; cursor: pointer; transition: box-shadow 0.2s ease; box-shadow: 0 4px 6px rgba(16, 185, 129, 0.25);" onmouseover="this.style.boxShadow='0 8px 12px rgba(16, 185, 129, 0.4)';" onmouseout="this.style.boxShadow='0 4px 6px rgba(16, 185, 129, 0.25)';">Create Assignment</button>
