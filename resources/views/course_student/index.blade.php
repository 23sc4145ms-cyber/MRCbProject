                    ...
                    <tr style="border-bottom: 1px solid #e5e7eb; transition: background-color 0.2s ease;" onmouseover="this.style.backgroundColor='#fdf2f8';" onmouseout="this.style.backgroundColor='transparent';">
                        ...
                        <td style="padding: 1rem; text-align: center;">
                            <div class="action-group">
                                <a href="{{ route('course_students.show', $courseStudent->id) }}" class="action-btn action-btn-sm action-btn-view" title="View">View</a>
                                <a href="{{ route('course_students.edit', $courseStudent->id) }}" class="action-btn action-btn-sm action-btn-edit" title="Edit">Edit</a>
