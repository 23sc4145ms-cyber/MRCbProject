...
<div class="dashboard-container">
    ...
    <div class="welcome-header">
        ...
        <p>Teacher Dashboard - View your information and manage your account</p>
    </div>
    ...
    <div id="tab-info" class="tab-content active">
        <div class="info-card">
            ...
            @php
                $teacher = \App\Models\Teacher::where('user_id', session('user_id'))->with('user')->first();
            @endphp
            ...
            @if($teacher)
                <div class="info-grid">
                    <div class="info-item">
                        ...
                        <div class="value">{{ $teacher->fname }}</div>
                    </div>
                    <div class="info-item">
                        <label>Middle Name</label>
                        <div class="value">{{ $teacher->mname ?? 'N/A' }}</div>
                    </div>
                    <div class="info-item">
                        <label>Last Name</label>
                        <div class="value">{{ $teacher->lname }}</div>
                    </div>
                    <div class="info-item">
                        <label>Username</label>
                        <div class="value">{{ $teacher->user->username }}</div>
                    </div>
                    <div class="info-item">
                        <label>Email Address</label>
                        <div class="value">{{ $teacher->user->email }}</div>
                    </div>
                    <div class="info-item">
                        <label>Contact Number</label>
                        <div class="value">{{ $teacher->contact }}</div>
                    </div>
                    <div class="info-item">
                        <label>Teacher ID</label>
                        <div class="value">{{ $teacher->id }}</div>
                    </div>
                    <div class="info-item">
                        <label>Role</label>
                        <div class="value" style="color: #90A854;">👨‍🏫 Teacher</div>
                    </div>
                    <div class="info-item">
                        <label>Status</label>
            ...
            @else
                <div class="empty-state">
                    <p>No Teacher information found. Please contact the administrator.</p>
                </div>
            @endif
        </div>
    </div>
