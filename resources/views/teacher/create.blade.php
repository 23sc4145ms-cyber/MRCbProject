    ...
    <div style="width:100%; max-width: 760px; background: #fff; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 10px rgba(16, 185, 129, 0.2);">
        ...
        <form action="{{ route('teachers.store') }}" method="POST">
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <input type="text" name="mname" value="{{ old('mname') }}" style="width:100%; padding:0.75rem; border:2px solid #d1fae5; border-radius:8px;" placeholder="Optional">
            </div>
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <input type="text" name="contact" value="{{ old('contact') }}" required style="width:100%; padding:0.75rem; border:2px solid #d1fae5; border-radius:8px;" placeholder="09XXXXXXXXX">
            </div>
